...
if _LANG == "cn":
    ...
    <strong><h5 align="center"> 你说的对，但是《LLM Riddles：完蛋！我被 LLM 拿捏了》是由开源社区仿照《完蛋！我被大模型包围了》研发的一款全新开放世界冒险游戏。游戏发生在一个被称作「LLM」的幻想世界，在这里，你将扮演一位名为「提示词工程师」的神秘角色，在自由的旅行中邂逅题型各异、让人脑洞大开的试题，和他们一起击败大语言模型（GLM-4-Air），找到问题的答案——同时，逐步发掘关于「Prompt Engineering」的真相。 <h5></strong>
